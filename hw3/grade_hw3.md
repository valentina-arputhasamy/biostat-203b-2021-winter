...
### Quality of report: 6/10

-   Is the homework submitted (git tag time) before deadline?

-   Is the final report in a human readable format html?  No **HTML missing**
...
Q1.8 Some deathtimes are NA (did not die, thirty d ay mortality should be 0 there not NA). -3pts 
...
**You did not include the .rds file, couldn't launch app without using someone else's file** 
