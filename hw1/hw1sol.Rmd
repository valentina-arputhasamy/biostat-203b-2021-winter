...
for string in 'Elizabeth' 'Jane' 'Lydia' 'Darcy'
  do grep $string pride_and_prejudice.txt | wc -l
done
```

The name `Elizabeth` occurrs 633 times, the name `Jane` occurs 290 times, the name `Lydia` occurs 166 times, and the name `Darcy` occurs 414 times. Therefore, the name `Elizabeth` is the name that was most mentioned in the book *Pride and Prejudice*, followed by the name `Darcy`. 
