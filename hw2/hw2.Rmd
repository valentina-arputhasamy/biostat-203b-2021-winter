...
admissions2 %>% ggplot(aes(admit_hour)) + geom_bar(binwidth = 1, fill = "lightsteelblue2", color = "lightsteelblue4") + ggtitle("Number of Admits by Hour") + xlab("Hour") + theme_minimal()
```
...
patients %>% ggplot(aes(anchor_age)) + 
  geom_bar(binwidth = 1, fill = "lightsteelblue2", color = "lightsteelblue4") + ggtitle("Number of Patients by Gender") + xlab("Anchor Age") + theme_minimal() 
```
...
want.id <- c(50912, 50971, 50983, 50902, 50882, 51221, 51301, 50931, 50960, 50893, 50813)

labevents.want <- labevents %>% 
  filter(V3 %in% want.id)
```
