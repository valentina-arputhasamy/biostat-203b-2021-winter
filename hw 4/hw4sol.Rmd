...
```{r}
plotDistributions(micedf ,vars= c("marital_status", "bicarbonate", "calcium", 
...
```{r}
plotCorrelations(micedf,vars=c("marital_status", "bicarbonate", "calcium", 
...
```{r}
plotVarConvergence(micedf,vars=c("marital_status", "bicarbonate", "calcium", 
                                 "chloride", "creatinine", "glucose", 
                                 "magnesium", "potassium", "sodium", 
                                 "hematocrit", "wbc", "heart_rate", 
                                 "non_invasive_blood_pressure_systolic", 
...
```{r}
plotModelError(micedf,vars=c("marital_status", "bicarbonate", "calcium", 
                             "chloride", "creatinine", "glucose", "magnesium", 
                             "potassium", "sodium", "hematocrit", "wbc", 
                             "heart_rate", 
                             "non_invasive_blood_pressure_systolic", 
...
```{r}
#ImputedList <- completeData(micedf)
df1 <- ImputedList$Dataset_1 
df2 <- ImputedList$Dataset_2 
df3 <- ImputedList$Dataset_3 
>>>>>>> develop
